...
#pragma omp parallel for num_threads(56) reduction(+:mycount,local_edge_error) schedule(dynamic,512)
...
time_compute  += t3-t2; 
		...
		sub_error += local_edge_error;

	}
//	cout<<"subproblem edge error = "<<sub_error<<endl;
	buffer-> Edge_free();
